...
html"""
<p style="font-size:20px;">Julia O'Connor</br>
...
# ╔═╡ b5ea4faf-790d-4a1a-bd3e-ad7f8d37c9ee
html"""
<p> 
I got 9 rows of P, indicating 9 extreme pathways. Reaction v3 produces urea, so 3/9 pathways produce urea.<br>
<br/>
Reaction Frequencies: </br>
The reaction frequency of v1 is 3/9. </br>
The reaction frequency of v2 is 3/9.</br>
The reaction frequency of v3 is 3/9. </br>
The reaction frequency of v4 is 4/9.</br>
The reaction frequency of forward v5 is 3/9. </br>
The reaction frequency of reverse v5 is 2/9.</br>
The reaction frequency of b1 is 4/9.</br>
The reaction frequency of b2 is 3/9.</br>
The reaction frequency of b3 is 3/9.</br>
The reaction frequency of b4 is 3/9.</br>
The reaction frequency of forward b5 is 2/9.</br>
The reaction frequency of reverse b5 is 3/9.</br>
The reaction frequency of forward b6 is 3/9.</br>
The reaction frequency of forward b6 is 2/9.
...
# ╔═╡ 617e4549-66d6-48ba-b6b5-ee13de822d76
html"""
<p>

Ranked order (most to least) of metabolite connectivity is found by looking at the diagonal of the MCA matrix. A higher number indicates that the metabolite is involved in more reactions. </br>
1.Fumarate</br>
2.Carbamoyl phosphate, urea</br>
3.Citrulline, aspartate, arginosuccinate, arginine, ornithine
</p>"""
...
# ╔═╡ 28b7dcf9-cf29-4202-9629-95adb6568fd0
html""" <p>
Ranked order (most to least) of reaction connectivity is found by looking at the diagonal of the RCA matrix. A higher number indicates that the reaction involves more metabolites.<br/>
1. v1, v2, v3, v4 <br/>
2.forward v5, reverse v5<br/>
3. b1, b2, b3, b4, forward b5, reverse b5, forward b6, reverse b6
</p>
"""


# ╔═╡ e461cf25-4b19-4719-b76e-9a90d2ddd98f
html"""<p>
Extreme pathway reaction frequency indicates the fraction of times that a reaction is used in steady-state solutions.<br/>
<br/>

The reaction connectivity array indicates the number of metabolites involved in both reactions, with the elements on the diagonal indicating the total number of reactants in each reaction.
</p>"""
...
begin
	...
	# Setup a collection of reaction strings:
		...
		#species_array=String["carbamoyl_phosphate","citrulline","aspartate","argininosuccinate","fumarate","arginine","urea","ornithine"]
	
	# encode the reactions:
		# internal reactions:
		push!(reaction_array,"v₁,citrulline+aspartate,argininosuccinate,false")
		push!(reaction_array,"v₂,argininosuccinate,fumarate+arginine,false")
		push!(reaction_array,"v₃,arginine,urea+ornithine,false")
		push!(reaction_array,"v₄,ornithine+carbamoyl_phosphate,citrulline,false")
		push!(reaction_array,"v₅,2*citrulline,2*arginine,true")

		# exchange reactions:
		push!(reaction_array,"b₁,∅,carbamoyl_phosphate,false")
	...
	#get size of array. expect M=# metabolites, R=#reactions input
	(M,R)=size(S)
end
...
# ╔═╡ 573186b3-0433-4045-b713-a6b335c19e1b
MCA
